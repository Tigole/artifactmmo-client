...
class AlchemySystem: public CraftOrderSystem
{
public:
    AlchemySystem(ItemCraftingManager& item_crafting_manager, InventoryManager& bank) :
        CraftOrderSystem("AlchemySystem", item_crafting_manager, bank)
    {
